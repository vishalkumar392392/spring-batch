...
public class LinkedinBatchApplication extends QuartzJobBean {
	...
	public Trigger trigger() {
		SimpleScheduleBuilder schedularBuilder =  SimpleScheduleBuilder
				.simpleSchedule()
				.withIntervalInSeconds(5)
				.repeatForever();
		return TriggerBuilder.newTrigger()
				.forJob(jobDetail())
				.withSchedule(schedularBuilder)
				.build();
	}

	@Bean
	public JobDetail jobDetail() {
		return JobBuilder.newJob(LinkedinBatchApplication.class).storeDurably().build();
	}
